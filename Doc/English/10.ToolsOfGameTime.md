...
TimeManager.instance.PopBlend(0.5f); // Remove the latest blend with a 0.5s transition 
TimeManager.instance.UpdateTimeScale(2f); // Directly update current scale to 2x  
TimeManager.instance.Pop(0.5f); // Pop the latest scaling with a 0.5s transition 
```  
