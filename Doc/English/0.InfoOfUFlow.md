...
- Provides tools/windows for automatically generating UI code skeletons.

### 3.📑 **Convenient Configuration Table Tools**

- Configuration table import tool developed based on EEPlus. It supports Excel and CSV configuration files and generates binary data indexed by index-chunk blocks.
- Provides convenient tool classes and windows to generate configuration table classes and resources with one click, and supports integrating the generation process into custom build workflows.
- Binary configuration table resources support encryption/decryption.
...
- Provides persistent data version control and data migration capabilities.
...
- Provides log code generation tools and supports custom log code formats.
