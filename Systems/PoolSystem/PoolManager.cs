...
namespace PowerCellStudio
{
    ...
    public class PoolManager : SingletonBase<PoolManager>, IOnGameStartModule
    {
            ...
            where T : class, IPoolable
        {
            ...
            if (obj == null) ModuleLog<PoolManager>.LogError($"{typeof(T).Name} is null, {typeof(T).Name} was unregistered, groupName: " + groupName);
            return obj;
        }
        ...
        public GameObject GetGameObject(string path, PoolGroupName groupName = PoolGroupName.Default)
        {
            ...
            if (go == null) ModuleLog<PoolManager>.LogError("GameObject is null, path was unregistered, path: " + path + ", groupName: " + groupName);
            return go;
        }
